...
"""
Sanchari V4 - Threshold Optimisation Script (optimize_threshold.py)
...
Output:
    threshold_optimization.png -- IoU vs threshold curve.
...
def optimize_threshold(model, loader, device):
    ...
    plt.ylabel("Mean IoU")
    plt.grid(True)
    plt.savefig(os.path.join(BASE_DIR, "threshold_optimization.png"))
    print("Saved plot to threshold_optimization.png.")
