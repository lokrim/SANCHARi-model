...
"""
Sanchari V4 - Lovasz Fine-Tuning Script (train_lovasz.py)
...
errors.  This script should be run after main training with train.py.

Usage:
    python train_lovasz.py
"""
...
CONFIG = {
    ...
    "PRETRAINED_MODEL_PATH": os.path.join(BASE_DIR, "weights/best_model_v4.pth"),
    "MODEL_SAVE_PATH":       os.path.join(BASE_DIR, "weights/best_model_lovasz.pth"),
    "LOG_FILE":              os.path.join(BASE_DIR, "training_log_lovasz.csv"),
...
def main():
    ...
    if not os.path.exists(img_dir):
        print(f"Error: Data not found at {img_dir}. Run preprocess.py first.")
        return
