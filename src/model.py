...
class UNet(nn.Module):
    ...
    The model is configurable for the number of input channels, output classes,
    and whether to use bilinear upsampling.
    """
...
if __name__ == '__main__':
    ...
    n_classes = 1   # Binary segmentation (road or not road)
    
    # Create a dummy input tensor
    # Batch size = 2, Channels = 3, Height = 256, Width = 256
    dummy_input = torch.randn(2, n_channels, 256, 256).to(device)
    ...
    assert output.shape == (2, n_classes, 256, 256)
