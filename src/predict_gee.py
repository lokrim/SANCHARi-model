...
from main_gee import GEE_PROJECT, GEE_SCALE, GEE_IMAGE_COLLECTION

_SRC_DIR  = os.path.dirname(os.path.abspath(__file__))
_REPO_ROOT = os.path.dirname(_SRC_DIR)
MODEL_PATH = os.path.join(_REPO_ROOT, 'weights', 'best_model_v3.pth')
OUTPUT_IMG_DIR = os.path.join(_REPO_ROOT, 'predicted', 'predictedv3')
OUTPUT_GEOJSON_DIR = os.path.join(_REPO_ROOT, 'predicted', 'output-geojson')
WINDOW_SIZE = 1024
PATCH_SIZE  = 256
STRIDE      = 128
THRESHOLD   = 0.3
