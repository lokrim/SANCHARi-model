...
# --- Configuration ---
# Paths are anchored to the repo root (one level above this script's src/ directory),
# so the server works whether launched as `python src/main.py` or `cd src && python main.py`.
_SRC_DIR  = os.path.dirname(os.path.abspath(__file__))
_REPO_ROOT = os.path.dirname(_SRC_DIR)
GEOTIFFS_DIR = os.path.join(_REPO_ROOT, 'geotiffs')
