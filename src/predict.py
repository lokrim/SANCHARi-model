...
"""
Sanchari V4 - Local Batch Inference Script (predict.py)
...
Usage:
    python predict.py
    python predict.py --input test-images --output predicted
"""
...
from postprocess import apply_advanced_postprocessing
...
OUTPUT_DIR      = os.path.join(BASE_DIR, "predicted/predicted")
