...
4.  **Outputs**:
    - `predictedv3/`: Saves Input, Probability Map, Binary Mask, Skeleton, and Overlay.
    - `output-geojson/`: Saves vector data for each prediction.
...
OUTPUT_IMG_DIR = 'predictedv3'
OUTPUT_GEOJSON_DIR = 'output-geojson'
WINDOW_SIZE = 1024
PATCH_SIZE = 256
STRIDE = 128
